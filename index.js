        ...
        return Bedrock.Html.Builder
            .begin("div", { style: { width: "100%", margin: "0" } })
                .begin ("http://www.w3.org/2000/svg;svg", { attributes: { width: "100%", viewBox: "-1 -1 2 2" },  style: { margin: "0", display: "block" } })
                    ...
                    .add ("http://www.w3.org/2000/svg;text", { attributes: { x: right + v2CharSpacing, y: -0.075, fill: "black", "font-family": "Helvetica, Arial", "font-size": 0.4, "text-anchor": "start", "dominant-baseline": "central" }, innerHTML: v2 })
                .end ()
            .end ();
    };
